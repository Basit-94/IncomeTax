...
function systemPrompt(ctx: AgentContext): string {
  ...
  return [
    ...
    '- CODE_2: "Information is not fully correct" (disputed amount; needs the explanation and, ideally, proof)',
    '- CODE_3: "Information relates to other PAN / financial year"',
    '- CODE_4: "Information is duplicate" (e.g. reported by both the AMC and the RTA)',
