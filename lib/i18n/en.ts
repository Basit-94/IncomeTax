...
export const en = {
  ...
  onboarding: {
    ...
    title: "Let us set this up for you.",
    intro:
      "Five quick answers help us choose the right language, pace, and tax questions. You can change them later.",
    languageQuestion: "Which language should we use?",
    languageHelp: "This is the first thing we ask. You can switch it any time.",
    intentQuestion: "What brought you here today?",
    intentHelp: "We will put that job first.",
    intentOptions: {
      file_return: {
        label: "File this year's return",
        detail: "Start with what is already known about you.",
      },
      check_refund: {
        label: "Check if money is due to me",
        detail: "See what was reported, what was paid, and what may come back.",
      },
      understand_notice: {
        label: "Understand a letter or notice",
        detail: "See what it says, what is at stake, and what to do next.",
      },
      correct_prefill: {
        label: "Fix something that looks wrong",
        detail: "Find the source of a number and record what should change.",
      },
    },
    intentCta: {
      file_return: "Start my return",
      check_refund: "Check what is owed to me",
      understand_notice: "Show me what to do",
      correct_prefill: "Review what was reported",
    },
    situationQuestion: "Tell us about your tax life.",
    situationHelp: "Two quick answers are enough here.",
    professionLabel: "What best describes your work?",
    professionOptions: {
    ...
    filingHistoryLabel: "Have you filed an income-tax return before?",
    filingHistoryOptions: {
      never: "No, this is my first time",
      once: "Once or twice",
      every_year: "Every year",
    },
    incomeQuestion: "What was your total income from all sources, roughly?",
    incomeHelp: "A range is enough. We do not need an exact number yet.",
    incomeOptions: {
      none: "No income",
      under_4: "Under ₹4 lakh",
      "4_to_8": "₹4 to ₹8 lakh",
      "8_to_12": "₹8 to ₹12 lakh",
    ...
    focusOptions: {
      ...
      rent: "Rent I pay or receive",
      interest: "Bank interest",
      investments: "Shares or investments",
      deductions: "Savings, insurance, home loan, or NPS",
      not_sure: "I am not sure yet",
    },
    chooseOne: "Choose one",
    chooseAtLeastOne: "Choose at least one",
    questionsLabel: "Quick setup",
    questionsProgress: (current: number, total: number) => `${current} of ${total}`,
    savedLocally: "Your answers are saved in this browser in this prototype.",
    readyTitle: "That is enough to make this personal.",
    readyBody:
      "We will use these answers to choose what you see first. The final regime choice still uses the facts and claims you confirm.",
    guidedLabel: "How we will explain things",
    guidedValue: "We will explain terms as we go.",
    quickValue: "We will keep the path short.",
    regimeLabel: "How we will handle the regimes",
    claimsRegimeValue: "We will check your claims before choosing between them.",
    compareRegimeValue: "We will compare both after your facts are confirmed.",
    focusLabel: "What we will put first",
    startPath: "Start with my path",
    changeAnswers: "Change answers",
    tailoredBadge: "Your starting path",
    tailoredGuided: "Guided explanations",
    tailoredQuick: "Short path",
