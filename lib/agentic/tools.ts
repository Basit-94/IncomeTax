  ...
  read_document_fields: tool({
    ...
    async run(args, ctx) {
      ...
      return {
        ...
        status: ex.status,
        fields: {
          grossSalary: ex.fields.grossSalary,
          tds: ex.fields.tds,
          employerName: ex.fields.employerName,
          // The Part B / AIS rows an issued document carries (2026-09-07); still no PAN, name or DOB.
          tan: ex.fields.tan,
          professionalTax: ex.fields.professionalTax,
          exemptAllowances: ex.fields.exemptAllowances,
          employerClaims: ex.fields.employerClaims,
          otherIncome: ex.fields.otherIncome,
          ltcg112A: ex.fields.ltcg112A,
          tdsOther: ex.fields.tdsOther,
        },
