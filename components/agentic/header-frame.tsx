    ...
    <div className="h-7 shrink-0 bg-[var(--banner-bg)] text-[var(--banner-fg)] px-4 text-[11px] flex items-center justify-between font-mono font-semibold" data-testid="prototype-banner">
      ...
      <div className="flex items-center gap-3">
        <a
          ...
          className="group inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/10 hover:bg-[#0A66C2]/20 text-[10.5px] text-[var(--banner-fg)] hover:text-white border border-white/15 hover:border-[#0A66C2]/40 transition-all font-sans font-medium"
          title="Connect with Abdul Basit Siddiqui on LinkedIn"
        >
          <svg className="w-3 h-3 fill-current text-[#0A66C2] group-hover:scale-110 transition-transform" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <span className="hidden md:inline text-white/60">{t.shell.taxYear}</span>
      </div>
    </div>
  );
}
