  ...
  return (
    <div className="h-7 shrink-0 bg-[var(--banner-bg)] text-[var(--banner-fg)] px-4 text-[11px] flex items-center justify-between font-mono font-semibold" data-testid="prototype-banner">
      ...
      <div className="flex items-center gap-3">
        <div
          className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/10 text-[10.5px] text-[var(--banner-fg)] border border-white/15 transition-all font-sans font-medium"
        >
          <svg className="w-3 h-3 fill-current text-[#0A66C2]" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a
            ...
            className="font-semibold text-white hover:text-[#5EE6B0] hover:underline underline-offset-2 transition-colors"
