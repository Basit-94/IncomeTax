  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox={compact ? "48 22 172 182" : "0 0 256 256"} className={`munshi-svg ${className}`} data-state={state} data-animated={animated} data-compact={compact} role={title ? "img" : undefined} aria-label={title} aria-hidden={title ? undefined : true} focusable="false">
      ...
      <g className="mj-body" data-part="body">
        ...
        {state === "chai" && <g className="mj-chai-arm" data-part="right-arm"><path d="M73 158 Q61 163 58 176 Q57 187 67 194 L82 181 Q80 168 73 158Z" fill={paint("shirt")}/><path d="M62 179 Q58 187 64 195" fill="none" stroke="#EDB98E" strokeWidth="1.2"/><g className="mj-chai-forearm"><path d="M63 181 Q62 193 72 199 Q82 205 92 196 L117 172 Q124 166 120 160 Q116 154 109 160 L85 181 Q79 187 73 184 Q69 181 63 181Z" fill={paint("skin")} stroke="#DC8A5B" strokeWidth=".7"/><path d="M104 160 Q106 153 112 150 Q118 148 121 154 L119 165 Q112 170 106 166Z" fill={paint("skin")}/><g className="mj-chai" data-part="chai"><g className="mj-steam" fill="none" stroke="#D69A6A" strokeWidth="2" strokeLinecap="round"><path d="M119 137 Q114 131 120 125 Q125 120 120 115"/><path d="M129 137 Q124 131 130 125"/></g><path d="M111 139 H138 V154 Q136 162 125 163 Q114 162 112 154Z" fill="#FFF5E7" stroke="#C99769" strokeWidth="1.4"/><path d="M114 140 H136" stroke="#FF7A1A" strokeWidth="3" strokeLinecap="round"/><path d="M111 143 Q101 142 101 151 Q101 160 111 159" fill="none" stroke="#C99769" strokeWidth="4"/><path d="M106 145 Q101 147 102 152 Q103 157 108 158" fill="none" stroke="#ECA174" strokeWidth="3.2" strokeLinecap="round"/></g></g></g>}
