...
export type MunshiState = "idle" | "welcome" | "listening" | "explaining" | "working" | "reading" | "uploading" | "happy" | "concerned" | "success" | "error" | "waiting" | "secure" | "review-delivered" | "deadline" | "guide" | "noting" | "voice" | "chai";
...
export function MunshiArt({ id, size = 120, state = "idle", className = "", title, animated = true, compact = false, children }: MunshiArtProps) {
  ...
  const concerned = state === "concerned" || state === "error" || state === "deadline";
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox={compact ? "48 22 172 182" : "0 0 256 256"} className={`munshi-svg ${className}`} data-state={state} data-animated={animated} data-compact={compact} role={title ? "img" : undefined} aria-label={title} aria-hidden={title ? undefined : true} focusable="false">
      ...
      <g className="mj-body" data-part="body">
        ...
        <g data-part="pocket"><path d="M162 204 L187 204 L186 222 Q183 231 173 230 Q160 229 162 204Z" fill="#FFE6C9" stroke="#EFC39F" strokeWidth=".8"/><g className="mj-pocket-pen"><path d="M171 209 L171 197 Q172 192 175 194 Q178 195 177 200 L177 211" fill="#FF7A1A"/><path d="M174 197 L174 211" stroke="#EF5B0C" strokeWidth="1.2" strokeLinecap="round"/></g></g>
        ...
        {state === "voice" && <g className="mj-voice-sound" data-part="voice-sound" fill="none" stroke="#FF7A1A" strokeWidth="3" strokeLinecap="round"><path d="M70 92 Q62 102 68 114"/><path d="M62 84 Q48 102 58 122"/></g>}
        {state !== "chai" && <g className={reading ? "mj-adjust-arm" : state === "review-delivered" ? "mj-review-arm" : state === "deadline" ? "mj-deadline-arm" : guide ? "mj-guide-arm" : state === "noting" ? "mj-note-arm" : state === "voice" ? "mj-voice-arm" : wave ? "mj-wave-arm" : "mj-rest-arm"} data-part="right-arm"><path d="M67 177 Q53 185 43 171 L31 151 L47 142 Q52 154 72 159Z" fill={paint("shirt")}/><path d="M43 166 Q49 166 52 157 L47 148 L34 153Z" fill="#EEC099" opacity=".55"/><path d="M34 155 Q23 145 18 128 Q12 109 21 105 Q27 100 33 110 L39 120 Q46 112 49 119 Q51 127 46 140 Q44 149 34 155Z" fill={paint("skin")}/><path d="M19 111 Q14 127 29 145" fill="none" stroke="#DF8F61" strokeWidth="1" opacity=".7"/>
          {state === "review-delivered" && <g className="mj-review-envelope" data-part="review-envelope"><path d="M13 117 Q13 114 17 114 H59 Q63 114 63 118 V148 Q63 152 59 152 H17 Q13 152 13 148Z" fill="#FFF1D9" stroke="#C99769" strokeWidth="1.5"/><path d="M15 117 L38 134 L61 117" fill="#FFE4BF" stroke="#C99769" strokeWidth="1.2" strokeLinejoin="round"/><path d="M15 150 L29 132 M61 150 L47 132" fill="none" stroke="#D7AC83" strokeWidth="1"/><g className="mj-review-seal"><circle cx="38" cy="136" r="5.5" fill="#FF7A1A"/><path d="M35.5 136 L37.2 138 L41 133.8" fill="none" stroke="#FFF7EC" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></g></g>}
          {state === "deadline" && <g className="mj-deadline-clock" data-part="deadline-clock"><circle cx="38" cy="132" r="17" fill="#FFF1D9" stroke="#FF7A1A" strokeWidth="3.5"/><path d="M28 117 Q22 110 17 117 M48 117 Q54 110 59 117" fill="#FF7A1A" stroke="#D95E0B" strokeWidth="1.5" strokeLinecap="round"/><path d="M30 147 L26 153 M46 147 L50 153" stroke="#61330F" strokeWidth="3" strokeLinecap="round"/><path d="M38 132 L38 121 M38 132 L46 126" stroke="#55321A" strokeWidth="2.5" strokeLinecap="round"/><circle cx="38" cy="132" r="2.5" fill="#55321A"/></g>}
          {state === "noting" && <g className="mj-note-ledger" data-part="note-ledger"><path d="M10 114 Q10 111 14 111 H61 Q64 111 64 115 V151 H14 Q10 151 10 147Z" fill="#553016" stroke="#3A210E" strokeWidth="1.2"/><path d="M15 115 H59 V147 H15Z" fill="#FFF1DA"/><path d="M19 121 H51 M19 128 H54 M19 135 H47" stroke="#B18B69" strokeWidth="1.4" strokeLinecap="round"/><path d="M14 113 V150" stroke="#2F1A09" strokeWidth="2.5"/><path className="mj-note-stroke" d="M20 142 Q34 138 53 142" fill="none" stroke="#FF7A1A" strokeWidth="2.6" strokeLinecap="round"/></g>}
        </g>}
        {state === "chai" && <g className="mj-chai-arm" data-part="right-arm"><ellipse cx="68" cy="178" rx="10.5" ry="14" transform="rotate(18 68 178)" fill={paint("shirt")}/><path d="M61 184 Q68 190 77 182" fill="none" stroke="#EDB98E" strokeWidth="1.1" strokeLinecap="round"/><g className="mj-chai-forearm"><path d="M67 183 Q67 191 74 195 Q80 198 87 192 L104 176" fill="none" stroke={paint("skin")} strokeWidth="11" strokeLinecap="round" strokeLinejoin="round"/><g className="mj-chai-grip"><ellipse cx="105" cy="168" rx="7.2" ry="8" transform="rotate(-18 105 168)" fill={paint("skin")}/><g className="mj-chai" data-part="chai"><g className="mj-steam" fill="none" stroke="#D69A6A" strokeWidth="1.8" strokeLinecap="round"><path d="M120 154 Q115 148 121 142 Q126 137 121 132"/><path d="M130 154 Q125 148 131 142"/></g><path d="M113 156 H139 V173 Q137 181 126 182 Q115 181 114 173Z" fill="#FFF5E7" stroke="#C99769" strokeWidth="1.4"/><path d="M116 157 H136" stroke="#FF7A1A" strokeWidth="3" strokeLinecap="round"/><path d="M113 160 Q104 159 104 168 Q104 176 113 175" fill="none" stroke="#C99769" strokeWidth="4"/><path d="M108 161 Q104 163 105 168 Q106 173 110 174" fill="none" stroke="#ECA174" strokeWidth="2.8" strokeLinecap="round"/></g></g></g></g>}
